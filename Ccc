        ...
        if saved_thread_id:
                        ...
                        for btn in buttons:
                            try:
                                if btn.is_displayed():
                                    ...
                                    if 'message' in btn_text.lower() or 'message' in btn_label.lower():
                ...
                try:
                    ...
                    for elem in all_elements[:50]:
                        try:
                            ...
                            if ('message' in elem_text or 'message' in elem_label) and elem.is_displayed():
            ...
            try:
                ...
                for btn in continue_buttons:
                    ...
                    if ('continue' in btn_text or 'continue' in btn_label) and btn.is_displayed():
                            ...
                            if is_admin_match:
                                ...
                                try:
                                    ...
                                    for cont_btn in continue_buttons:
                                        ...
                                        if 'continue' in btn_text or 'continue' in btn_label:
...
st.markdown('<div class="footer">Made with by HASSAN RAJPUT | 2025 All Rights Reserved</div>', unsafe_allow_html=True)
